        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <Image src="/hero.png" width={350} height={150} alt="img" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex items-center justify-center space-x-3 text-foreground">
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-14 0a2 2 0 012-2h14a2 2 0 012 2"
              />
            </svg>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Discover our selection of premium honey and dry fruits, sourced
              from the finest regions and delivered fresh to your doorstep.
            </p>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 text-foreground">
                    <p className="text-lg leading-relaxed">
                      YAS TRADERS is passionate about bringing you the finest
                      quality honey and dry fruits. For over 5 years, we have
                      been sourcing premium products from across India and
                      beyond, ensuring that every item meets our high standards
                      of quality and authenticity.
                    </p>

                    <p className="text-lg leading-relaxed">
                      We work directly with local farmers and beekeepers,
                      building strong relationships that allow us to maintain
                      sustainable and ethical practices. Our commitment to
                      responsible sourcing ensures that you receive not only
                      delicious products but also items that are produced with
      ...
      <section id="work-with-us" className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-primary mx-auto mb-6"></div>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Join our growing network of partners and distributors to bring
              premium quality dry fruits and honey to customers across India and
              worldwide.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent className="space-y-4">
                <CardDescription className="text-muted-foreground">
                  Become a distributor for YAS TRADERS products in your region.
                  We offer competitive pricing, marketing support, and reliable
            ...
            <Card className="hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent className="space-y-4">
                <CardDescription className="text-muted-foreground">
                  Open your own YAS TRADERS retail store with our proven
                  business model. We provide comprehensive training, store setup
            ...
            <Card className="hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent className="space-y-4">
                <CardDescription className="text-muted-foreground">
                  We offer wholesale solutions for businesses and export
                  opportunities worldwide. Our products meet international
                  quality standards and can be customized to your requirements.
                </CardDescription>
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <svg
